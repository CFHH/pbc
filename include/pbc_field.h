...
struct pairing_s;
struct field_s {
  void (PBC_STDCALL *field_clear)(struct field_s *f);
  void (PBC_STDCALL *init)(element_ptr);
  void (PBC_STDCALL *clear)(element_ptr);

  void (PBC_STDCALL *set_mpz)(element_ptr, mpz_ptr);
  void (PBC_STDCALL *set_multiz)(element_ptr, multiz);
  void (PBC_STDCALL *set)(element_ptr, element_ptr);
  void (PBC_STDCALL *set0)(element_ptr);
  void (PBC_STDCALL *set1)(element_ptr);
  int (PBC_STDCALL *set_str)(element_ptr e, const char *s, int base);
  size_t(PBC_STDCALL *out_str)(FILE *stream, int base, element_ptr);
  void (PBC_STDCALL *add)(element_ptr, element_ptr, element_ptr);
  void (PBC_STDCALL *sub)(element_ptr, element_ptr, element_ptr);
  void (PBC_STDCALL *mul)(element_ptr, element_ptr, element_ptr);

  int (PBC_STDCALL *is_sqr)(element_ptr);
  void (PBC_STDCALL *sqrt)(element_ptr, element_ptr);

  // Defaults exist for these functions.
  int (PBC_STDCALL *item_count)(element_ptr);
  element_ptr (PBC_STDCALL *item)(element_ptr, int);
  element_ptr (PBC_STDCALL *get_x)(element_ptr);
  element_ptr (PBC_STDCALL *get_y)(element_ptr);
  void (PBC_STDCALL *set_si)(element_ptr, signed long int);
  void (PBC_STDCALL *add_ui)(element_ptr, element_ptr, unsigned long int);
  void (PBC_STDCALL *mul_mpz)(element_ptr, element_ptr, mpz_ptr);
  void (PBC_STDCALL *mul_si)(element_ptr, element_ptr, signed long int);
  void (PBC_STDCALL *div)(element_ptr, element_ptr, element_ptr);
  void (PBC_STDCALL *doub)(element_ptr, element_ptr);  // Can't call it "double"!
  void (PBC_STDCALL *multi_doub)(element_ptr*, element_ptr*, int n);
  void (PBC_STDCALL *multi_add)(element_ptr*, element_ptr*, element_ptr*, int n);
  void (PBC_STDCALL *halve)(element_ptr, element_ptr);
  void (PBC_STDCALL *square)(element_ptr, element_ptr);

  void (PBC_STDCALL *cubic) (element_ptr, element_ptr);
  void (PBC_STDCALL *pow_mpz)(element_ptr, element_ptr, mpz_ptr);
  void (PBC_STDCALL *invert)(element_ptr, element_ptr);
  void (PBC_STDCALL *neg)(element_ptr, element_ptr);
  void (PBC_STDCALL *random)(element_ptr);
  void (PBC_STDCALL *from_hash)(element_ptr, void *data, int len);
  int (PBC_STDCALL *is1)(element_ptr);
  int (PBC_STDCALL *is0)(element_ptr);
  int (PBC_STDCALL *sign)(element_ptr);  // satisfies sign(x) = -sign(-x)
  int (PBC_STDCALL *cmp)(element_ptr, element_ptr);
  int (PBC_STDCALL *to_bytes)(unsigned char *data, element_ptr);
  int (PBC_STDCALL *from_bytes)(element_ptr, unsigned char *data);
  int (PBC_STDCALL *length_in_bytes)(element_ptr);
  int fixed_length_in_bytes;  // length of an element in bytes; -1 for variable
  int (PBC_STDCALL *snprint)(char *s, size_t n, element_ptr e);
  void (PBC_STDCALL *to_mpz)(mpz_ptr, element_ptr);
  void (PBC_STDCALL *out_info)(FILE *, struct field_s *);
  void (PBC_STDCALL *pp_init)(element_pp_t p, element_t in);
  void (PBC_STDCALL *pp_clear)(element_pp_t p);
  void (PBC_STDCALL *pp_pow)(element_t out, mpz_ptr power, element_pp_t p);
