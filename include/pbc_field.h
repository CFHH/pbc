...
PBC_DECLSPEC_EXPORT void pbc_assert(int expr, char *msg, const char *func);
PBC_DECLSPEC_EXPORT void pbc_assert_match2(element_ptr a, element_ptr b, const char *func);
PBC_DECLSPEC_EXPORT void pbc_assert_match3(element_ptr a, element_ptr b, element_ptr c,
                       const char *func);
...
PBC_DECLSPEC_EXPORT void field_out_info(FILE* out, field_ptr f);

/*@manual internal
Initialize 'e' to be an element of the algebraic structure 'f'
and set it to be the zero element.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_init(element_t e, field_ptr f) {
  e->field = f;
  f->init(e);
}

PBC_DECLSPEC_EXPORT element_ptr element_new(field_ptr f);
PBC_DECLSPEC_EXPORT void element_free(element_ptr e);

/*@manual einit
Initialize 'e' to be an element of the algebraic structure that 'e2'
lies in.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_init_same_as(element_t e, element_t e2) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_clear(element_t e) {
  e->field->clear(e);
}
...
2 and 36.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline size_t element_out_str(FILE * stream, int base, element_t e) {
  return e->field->out_str(stream, base, e);
}

/*@manual eio
*/
PBC_DECLSPEC_EXPORT int element_printf(const char *format, ...);

/*@manual eio
*/
PBC_DECLSPEC_EXPORT int element_fprintf(FILE * stream, const char *format, ...);

/*@manual eio
*/
PBC_DECLSPEC_EXPORT int element_snprintf(char *buf, size_t size, const char *fmt, ...);
...
*/
PBC_DECLSPEC_EXPORT int element_vsnprintf(char *buf, size_t size, const char *fmt, va_list ap);

/*@manual eio
Convert an element to a human-friendly string.
Behaves as *snprintf* but only on one element at a time.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_snprint(char *s, size_t n, element_t e) {
  return e->field->snprint(s, n, e);
}

/*PBC_DECLSPEC_EXPORT*/ static inline void element_set_multiz(element_t e, multiz m) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_set_str(element_t e, const char *s, int base) {
...
Set 'e' to zero.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_set0(element_t e) {
  e->field->set0(e);
}
...
Set 'e' to one.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_set1(element_t e) {
  e->field->set1(e);
}
...
Set 'e' to 'i'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_set_si(element_t e, signed long int i) {
  e->field->set_si(e, i);
}
...
Set 'e' to 'z'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_set_mpz(element_t e, mpz_t z) {
  e->field->set_mpz(e, z);
}
...
Set 'e' to 'a'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_set(element_t e, element_t a) {
  PBC_ASSERT_MATCH2(e, a);
  e->field->set(e, a);
}

/*PBC_DECLSPEC_EXPORT*/ static inline void element_add_ui(element_t n, element_t a,
                                  unsigned long int b) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_to_mpz(mpz_t z, element_t e) {
  e->field->to_mpz(z, e);
}

/*PBC_DECLSPEC_EXPORT*/ static inline long element_to_si(element_t e) {
  mpz_t z;
  mpz_init(z);
  e->field->to_mpz(z, e);
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_from_hash(element_t e, void *data, int len) {
...
Set 'n' to 'a' + 'b'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_add(element_t n, element_t a, element_t b) {
...
Set 'n' to 'a' - 'b'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_sub(element_t n, element_t a, element_t b) {
  PBC_ASSERT_MATCH3(n, a, b);
  n->field->sub(n, a, b);
}
...
Set 'n' = 'a' 'b'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_mul(element_t n, element_t a, element_t b) {
  PBC_ASSERT_MATCH3(n, a, b);
  n->field->mul(n, a, b);
}

/*PBC_DECLSPEC_EXPORT*/ static inline void element_cubic(element_t n, element_t a) {
...
/*@manual earith
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_mul_mpz(element_t n, element_t a, mpz_t z) {
  PBC_ASSERT_MATCH2(n, a);
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_mul_si(element_t n, element_t a,
                                  signed long int z) {
  PBC_ASSERT_MATCH2(n, a);
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_mul_zn(element_t c, element_t a, element_t z) {
  mpz_t z0;
...
Set 'n' = 'a' / 'b'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_div(element_t n, element_t a, element_t b) {
  PBC_ASSERT_MATCH3(n, a, b);
  n->field->div(n, a, b);
}
...
Set 'n' = 'a' + 'a'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_double(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->doub(n, a);
}
...
PBC_DECLSPEC_EXPORT void element_multi_double(element_t n[], element_t a[], int m);

// Set n_i =a_i + b_i for all i at one time.
// Uses multi_add(), which only elliptic curves have at the moment.
PBC_DECLSPEC_EXPORT void element_multi_add(element_t n[], element_t a[],element_t b[], int m);

/*@manual earith
Set 'n' = 'a/2'
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_halve(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->halve(n, a);
}
...
Set 'n' = 'a'^2^
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_square(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->square(n, a);
}
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pow_mpz(element_t x, element_t a, mpz_t n) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pow_zn(element_t x, element_t a, element_t n) {
  mpz_t z;
  PBC_ASSERT_MATCH2(x, a);
  mpz_init(z);
  element_to_mpz(z, n);
...
Set 'n' = -'a'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_neg(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->neg(n, a);
}
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_invert(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->invert(n, a);
}
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_random(element_t e) {
  e->field->random(e);
}
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_is1(element_t n) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_is0(element_t n) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_cmp(element_t a, element_t b) {
...
zero otherwise.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_is_sqr(element_t a) {
  return a->field->is_sqr(a);
}

/*@manual ecmp
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_sgn(element_t a) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_sign(element_t a) {
  return a->field->sign(a);
}

/*PBC_DECLSPEC_EXPORT*/ static inline void element_sqrt(element_t a, element_t b) {
  PBC_ASSERT_MATCH2(a, b);
  a->field->sqrt(a, b);
}
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_length_in_bytes(element_t e) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_to_bytes(unsigned char *data, element_t e) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_from_bytes(element_t e, unsigned char *data) {
...
*/
PBC_DECLSPEC_EXPORT void element_pow2_mpz(element_t x, element_t a1, mpz_t n1, element_t a2,
                      mpz_t n2);
/*@manual epow
Also sets 'x' = 'a1'^'n1'^ 'a2'^'n2'^,
but 'n1', 'n2' must be elements of a ring *Z*~n~ for some integer n.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pow2_zn(element_t x, element_t a1, element_t n1,
...
*/
PBC_DECLSPEC_EXPORT void element_pow3_mpz(element_t x, element_t a1, mpz_t n1,
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pow3_zn(element_t x, element_t a1, element_t n1,
                                   element_t a2, element_t n2,
...
PBC_DECLSPEC_EXPORT void field_clear(field_ptr f);

PBC_DECLSPEC_EXPORT element_ptr field_get_nqr(field_ptr f);
PBC_DECLSPEC_EXPORT void field_set_nqr(field_ptr f, element_t nqr);
PBC_DECLSPEC_EXPORT void field_gen_nqr(field_ptr f);

PBC_DECLSPEC_EXPORT void field_init(field_ptr f);

/*PBC_DECLSPEC_EXPORT*/ static inline int mpz_is0(mpz_t z) {
  return !mpz_sgn(z);
...
*/
PBC_DECLSPEC_EXPORT int element_to_bytes_x_only(unsigned char *data, element_t e);
/*@manual etrade
Assumes 'e' is a point on an elliptic curve.
...
*/
PBC_DECLSPEC_EXPORT int element_from_bytes_x_only(element_t e, unsigned char *data);
/*@manual etrade
Assumes 'e' is a point on an elliptic curve.
Returns the length in bytes needed to hold the x-coordinate of 'e'.
*/
PBC_DECLSPEC_EXPORT int element_length_in_bytes_x_only(element_t e);
...
*/
PBC_DECLSPEC_EXPORT int element_to_bytes_compressed(unsigned char *data, element_t e);
...
Currently only implemented for points on an elliptic curve.
*/
PBC_DECLSPEC_EXPORT int element_from_bytes_compressed(element_t e, unsigned char *data);

/*@manual etrade
Returns the number of bytes needed to hold 'e' in compressed form.
Currently only implemented for points on an elliptic curve.
*/
PBC_DECLSPEC_EXPORT int element_length_in_bytes_compressed(element_t e);

/*@manual epow
Prepare to exponentiate an element 'in', and store preprocessing information
in 'p'.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pp_init(element_pp_t p, element_t in) {
  p->field = in->field;
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pp_clear(element_pp_t p) {
  p->field->pp_clear(p);
}
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pp_pow(element_t out, mpz_ptr power,
                                  element_pp_t p) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline void element_pp_pow_zn(element_t out, element_t power,
                                     element_pp_t p) {
  mpz_t z;
  mpz_init(z);
...
PBC_DECLSPEC_EXPORT void pbc_mpz_out_raw_n(unsigned char *data, int n, mpz_t z);
PBC_DECLSPEC_EXPORT void pbc_mpz_from_hash(mpz_t z, mpz_t limit,
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline int element_item_count(element_t e) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline element_ptr element_item(element_t e, int i) {
...
/*PBC_DECLSPEC_EXPORT*/ static inline field_ptr element_item_field(element_t e) {
...
*/
/*PBC_DECLSPEC_EXPORT*/ static inline element_ptr element_x(element_ptr a) {
  return a->field->get_x(a);
}
/*@manual etrade
Equivalent to `element_item(a, 1)`.
*/
/*PBC_DECLSPEC_EXPORT*/ static inline element_ptr element_y(element_ptr a) {
...
*/
PBC_DECLSPEC_EXPORT void element_dlog_brute_force(element_t x, element_t g, element_t h);

/*@manual epow
Computes 'x' such that 'g^x^ = h' using Pollard rho method, where
'x' lies in a field where `element_set_mpz()` makes sense.
*/
PBC_DECLSPEC_EXPORT void element_dlog_pollard_rho(element_t x, element_t g, element_t h);
...
PBC_DECLSPEC_EXPORT int pbc_trial_divide(int (*fun)(mpz_t factor,
