...
struct symtab_s;
PBC_EXTERN int PBC_STDCALL pbc_param_init_g(pbc_param_ptr par, struct symtab_s *tab);
...
*/
PBC_EXTERN void PBC_STDCALL pbc_param_init_g_gen(pbc_param_t p, pbc_cm_ptr cm);
