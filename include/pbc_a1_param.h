...
struct symtab_s;
PBC_EXTERN int PBC_STDCALL pbc_param_init_a1(pbc_param_ptr par, struct symtab_s *tab);
...
*/
PBC_EXTERN void PBC_STDCALL pbc_param_init_a1_gen(pbc_param_t param, mpz_t n);
