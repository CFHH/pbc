...
struct symtab_s;
PBC_DECLSPEC_EXPORT int PBC_STDCALL pbc_param_init_i(pbc_param_ptr par, struct symtab_s *);
...
cryptographic use.
*/
PBC_DECLSPEC_EXPORT void PBC_STDCALL pbc_param_init_i_gen(pbc_param_ptr par, int group_size);
